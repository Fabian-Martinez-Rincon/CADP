...
- O ***FALSO*** ya que por valor tambien se pueden modificar el contenido de todos los elementos, en cambio si queremos pasarlo por referencia, tenemos que guardar el puntero inicial en una variable aux
